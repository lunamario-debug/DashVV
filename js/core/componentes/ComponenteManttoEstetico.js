export default class ComponenteManttoEstetico {
    ...
    getNombre() { return 'Mantenimiento Estetico'; }

    _esEstetico(actividad) {
    ...
    _calcularCostoPantalla(pantalla, mesesActivos) {
        ...
        for (const ticket of tickets) {
            ...
            if ((mesesActivos.includes('all') || mesesActivos.includes(mes)) &&
                this._esEstetico(ticket.actividad || '')) {
    ...
    renderFicha(totales) {
        ...
        return `
            ...
            <div style="font-size:1.6rem; font-weight:900; color:#0f172a; margin-bottom:25px;">MANTTO. ESTETICO</div>
            <div style="display:flex; gap:12px; margin-bottom:25px;">
                <div class="ficha-filter-card" onclick="app.filtrarPorAtributo('estetico', 'global', 'todas', this)" style="flex:1; border:1px solid #e2e8f0; border-radius:12px; padding:18px 10px; text-align:center; background:#fff; cursor:pointer;">
                ...
                <div class="ficha-filter-card" onclick="app.filtrarPorAtributo('estetico', 'global', 'todas', this)" style="flex:1; border:1px solid #e2e8f0; border-radius:12px; padding:18px 10px; text-align:center; background:#fff; cursor:pointer;">
                    <div style="font-size:0.65rem; color:#64748b;">Mantenimientos</div>
    ...
    renderDetalleUbicacion(pantalla) {
        ...
        const filtrados = tickets.filter(t => {
            ...
            return this._esEstetico(t.actividad || '') && 
        ...
        return `
            <div style="background:#fff; border:1px solid #e2e8f0; border-radius:10px; padding:15px;">
                <div style="display:flex; justify-content:space-between; border-bottom:1px solid #f1f5f9; padding-bottom:10px; margin-bottom:12px;">
                    <span style="font-weight:900;">Estetico - ${pantalla.id}</span>

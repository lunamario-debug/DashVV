export default class ComponenteLicenciaQTM {
    ...
    _obtenerValor(gasto) {
        ...
        for (const clave of Object.keys(gasto)) {
            ...
            if ((claveLower.includes('qtm') || claveLower.includes('q.t.m')) && claveLower.includes('licencia')) {
                const val = Number(gasto[clave]) || 0;
                if (val > 0) return val;
            }
        }
    ...
    renderFicha(totales) {
        ...
        const mesesHTML = Object.keys(totales.gastosPorMes)
            ...
            .map(mes => `
                <div class="ficha-filter-row" onclick="app.filtrarPorAtributo('licQTM', 'mes', '${mes}', this)" 
        ...
        return `
            ...
            <div style="font-size:1.6rem; font-weight:900; color:#0f172a; margin-bottom:25px; letter-spacing:-0.5px;">LICENCIA QTM</div>
            
            <div style="display:flex; gap:12px; margin-bottom:25px;">
                <div class="ficha-filter-card" onclick="app.filtrarPorAtributo('licQTM', 'global', 'todas', this)"
            ...
            <div style="border:1px solid #e2e8f0; border-radius:12px; padding:15px; background:#fff;">
                ...
                <div class="ficha-filter-row" onclick="app.filtrarPorAtributo('licQTM', 'global', 'todas', this)" 
        ...
        return `
            <div style="background:#fff; border:1px solid #e2e8f0; border-radius:10px; padding:15px; margin-bottom:15px;">
                <div style="display:flex; justify-content:space-between; align-items:center; border-bottom:1px solid #f1f5f9; padding-bottom:10px; margin-bottom:12px;">
                    <span style="font-weight:900; color:#0f172a;">📊 Licencia QTM - ${pantalla.id}</span>
